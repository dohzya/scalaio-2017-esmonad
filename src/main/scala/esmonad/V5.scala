...
trait V5Journal { self: V4Handler =>
...
trait V5Models { self: V4Handler with V5Journal => // Complete Event Sourced
...
object V5 extends V5Models with V4Handler with V5Journal
